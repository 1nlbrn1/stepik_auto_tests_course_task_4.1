...
class LoginPageLocators:
    ...
    REGISTRATION_FORM_PASSWORD1 = (By.CSS_SELECTOR, "#id_registration-password1")
    REGISTRATION_FORM_PASSWORD2 = (By.CSS_SELECTOR, "#id_registration-password2")
...
class BasketPageLocators:
    INNER_TITLE = (By.CSS_SELECTOR, "#content_inner>.basket-title")
